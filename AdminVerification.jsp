							...
							<tbody>
								<c:forEach var="verification" items="${verificationList }">
									<tr>
										...
										<td id="${verification.reqvCode }">${verification.vafterGrade }</td>
										<td>${verification.effectiveDate }</td>
										...
										<td>
											<c:if test="${verification.vsContent=='검증실패'}">
												<button type="button" value="${verification.reqvCode }" class="btn btn-default updatebtn" disabled="disabled" style="background-color: #ff4d4d">실패</button>
											</c:if>
											<c:if test="${verification.vsContent=='검증완료' }">
												<button type="button" value="${verification.reqvCode }" class="btn btn-default updatebtn" disabled="disabled">완료</button>
											</c:if>
										...
										<td>
											<c:if test="${verification.vsContent=='검증실패'}">
												<button type="button" value="${verification.vcode }" class="btn btn-default updatebtn cause" style="background-color: #ff4d4d;">조회</button>
											</c:if>
											<c:if test="${verification.vsContent=='검증완료'}">
												<button type="button" value="${verification.vcode }" class="btn btn-default updatebtn cause">조회</button>
											</c:if>
											<c:if test="${verification.vsContent=='검증 중' || verification.vsContent=='검증대기' }">
												<button type="button" value="${verification.vcode }" class="btn btn-default updatebtn" disabled="disabled">조회</button>
											</c:if>
										</td>
