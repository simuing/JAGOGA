...
<title>MyRoomVerificationComplete.jsp</title>
...
<div class="container">
   ...
   <div class="row">
      ...
      <div class="resultMent col-md-10">
         <div class="col-md-12"><h1>검증신청이 완료되었습니다.</h1></div>
         <div class="col-md-6"><a href="main.do"><button type="button" class="btn nextbtn">메인으로</button></a></div>
         <div class="col-md-6"><a href="myroomlist.do"><button type="button" class="btn nextbtn">숙소목록</button></a></div>
      </div>
   <div class="col-md-1"></div>
   </div>
</div>
