...
public class VnoticeDTO
{
   ...
   // 고객 부분
   private String ntTitle, ntRegDate, ntHitCount, ntAttach, ntContent;
   ...
   public void setNtCode(int ntCode)
   {
      this.ntCode = ntCode;
   }
   public void setNtRegDate(String ntRegDate)
