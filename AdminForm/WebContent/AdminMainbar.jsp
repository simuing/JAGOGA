	...
	<div class="container" style="width:100%; height: 24px;">
		<div class="navbar-header">
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					<a class="navbar-brand mainbar" href="index.jsp">
...
<!-- 				<li><a href="index.jsp" class="active"><i class="lnr lnr-home"></i> <span>대시보드</span></a></li> -->
				<li><a href="index.jsp" class=""><i class="lnr lnr-home"></i> <span>대시보드</span></a></li>
				<li><a href="Admin.jsp" class=""><i class="lnr lnr-cog"></i> <span>관리자계정관리</span></a></li>
				...
				<li><a href="Averfication.jsp" class=""><i class="lnr lnr-linearicons"></i> <span>검증관리</span></a></li>
